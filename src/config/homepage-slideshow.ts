...
export const homepageSlideshowImages: SlideshowImageConfig[] = [
  ...
  { kind: "project", project: "notre-dame-des-champs", image: "260905 Rendu Chambre with noise.png", alt: "Vue 3D d'une chambre dans un appartement à Notre-Dame-des-Champs" },
];
